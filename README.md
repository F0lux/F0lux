...
[![My Skills](https://skillicons.dev/icons?i=js,ts,html,css,bootstrap,angular,vue,nodejs,express,docker,php,laravel,git,github,gitlab,mysql,py,django,c,cpp,java,qt,bash,ubuntu,debian)](https://skillicons.dev)
